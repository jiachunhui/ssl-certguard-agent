---
title: 开发指南
description: 面向开发者的 CertGuard Agent 构建、调试和贡献指南。技术栈：C# 12 / .NET 8。
---
...
| 文档 | 说明 |
|------|------|
| [构建发布](/dev/build) | 从源码构建 Agent |
| [贡献指南](/dev/contribute) | 如何参与开源贡献 |
...
| 打包 | Self-contained 单文件发布 |
 ...
 > 开始贡献之前，请阅读 **[贡献指南](/dev/contribute)** 了解编码规范和提交流程。
