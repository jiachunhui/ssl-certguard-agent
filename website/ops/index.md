---
title: 操作指南
description: CertGuard Agent 日常运维操作手册：命令行参考、配置文件说明、日志管理、更新与卸载。
---
...
| 文档 | 说明 |
|------|------|
| [命令行参考](/ops/cli) | 所有命令参数的完整说明 |
| [配置文件说明](/ops/config) | agent.json 配置详解 |
| [日志管理](/ops/logs) | 日志查看、分析和轮转配置 |
| [更新与卸载](/ops/update-uninstall) | 升级 Agent 版本和卸载操作 |
