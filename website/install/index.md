---
title: 安装指南
description: CertGuard Agent 完整安装说明，覆盖 Linux 与 Windows 平台：系统要求、安装方式选择、安装后检查清单。
---
 ...
 本文档提供 CertGuard Agent 的完整安装步骤。如果追求最快上手，请直接使用 [一键安装](/quickstart) 方式。
...
| 方式 | 适用场景 | 难度 |
|------|----------|------|
| [一键安装脚本](/quickstart) | 首次体验、快速部署 | ⭐ |
| [Linux 手动安装](/install/linux) | 自定义安装路径、离线环境 | ⭐⭐ |
| [Windows 手动安装](/install/windows) | 自定义安装、需要精细控制 | ⭐⭐ |
...
- [ ] （可选）调整心跳间隔等配置
 ...
 > 遇到安装问题？请查阅 **[常见问题](/faq)** 或 **[服务支持](/support)**。
